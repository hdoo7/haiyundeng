...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/haiyundeng/";
    },
  },{id: "nav-publications",
          title: "Publications",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/haiyundeng/publications/";
          },
        },{id: "nav-projects",
          title: "projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/haiyundeng/projects/";
          },
        },{id: "nav-repositories",
          title: "repositories",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/haiyundeng/repositories/";
          },
        },{id: "nav-cv",
          title: "cv",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/haiyundeng/cv/";
          },
        },{id: "nav-teaching",
          title: "teaching",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/haiyundeng/teaching/";
          },
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%64%65%6E%67%30%30%37@%66%69%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/haiyun-deng", "_blank");
        },
      },{
        id: 'social-scholar',
